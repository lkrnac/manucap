...
describe("CueLine", () => {
    ...
    // TODO: Cover in CueList test cases
    ...
    //                 <CueLine
    //                     rowIndex={1} cue={cues[1]} playerTime={0} onClickHandler={(): void => undefined} lastCue />
    //             </div>
    //         </Provider>
    //     );
    ...
    //         <Provider store={testingStore}>
    //             <div className="testing-cues-container">
    //                 <CueLine rowIndex={1} cue={cues[1]} playerTime={0} onClickHandler={(): void => undefined} />
    //             </div>
    //         </Provider>
    //     );
    //     const cueLine = actualNode.find(CueLine);
