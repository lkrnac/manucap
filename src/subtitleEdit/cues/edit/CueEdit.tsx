                    ...
                    <div style={{ display: "flex", flexDirection:"column", paddingBottom: "15px" }}>
                        <TimeEditor
                            ...
                            onChange={(starTime: number): void => {
                                ...
                                setErrorMessage(starTime >= props.cue.vttCue.endTime ?
                                    "End time has to be greater than start time" : "");
                            }}
                        />
                        <TimeEditor
                            referenceTime={props.cue.vttCue.startTime}
                            ...
                            onChange={(endTime: number): void => {
                                ...
                                setErrorMessage(props.cue.vttCue.startTime >= endTime ?
                                    "End time has to be greater than start time" : "");
                            }}
                        />
                    </div>
                    <div style={{ display: "flex", justifyContent: "space-between" }}>
                        ...
                        <PositionButton
                            ...
                            changePosition={(position: Position): void => {
                                const newCue =
                                    new VTTCue(
                                        props.cue.vttCue.startTime,
                                        props.cue.vttCue.endTime,
                                        props.cue.vttCue.text
                                    );
                                copyNonConstructorProperties(newCue, props.cue.vttCue);
