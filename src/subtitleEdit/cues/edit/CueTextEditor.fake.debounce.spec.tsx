    ...
    <div style={{ display: "flex", flexDirection: "column", height: "100%" }}>
        ...
        >
            <div className="tw-text-sm" style={{ paddingLeft: "5px", paddingTop: "10px" }}>
                ...
                <span>CHARACTERS: <span className="tw-text-success">{chars.reduce((a, b) => a + b, 0)}</span>, </span>
                <span>WORDS: <span className="tw-text-success">{words.reduce((a, b) => a + b, 0)}</span>, </span>
                <span>CPS: <span className="tw-text-success">{cps.reduce((a, b) => a + b, 0).toFixed(1)}</span></span>
            </div>
        </div>
        <div
