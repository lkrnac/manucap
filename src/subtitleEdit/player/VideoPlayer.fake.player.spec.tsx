...
describe("VideoPlayer tested with fake player", () => {
    ...
    it("does not update lastCueChange cue line value when customizing position on lastCueChange edit event", () => {
        // GIVEN
        const fontPercent = 1.25;
        ...
        // WHEN
        const newCue = new VTTCue(1, 2, "newCue");
        newCue.line = testingLine;
        const cueChange = { changeType: "ADD", index: 1, vttCue: newCue };
        actualNode.setProps({
        ...
        // THEN
        expect(cueChange.vttCue.line).toEqual(testingLine);
    });
    ...
    it("does not update lastCueChange cue line value when customizing position on lastCueChange edit event", () => {
        ...
        // WHEN
        const updatedCue = new VTTCue(1, 2, "Updated Cue");
        updatedCue.line = 9;
        const cueChange = { changeType: "EDIT", index: 0, vttCue: updatedCue };
        actualNode.setProps({
            lastCueChange: cueChange
        });
        ...
        // THEN
        expect(cueChange.vttCue.line).toEqual(9);
    });
